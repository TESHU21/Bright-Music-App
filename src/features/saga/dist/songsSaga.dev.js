...
function workGetSongsFetch() {
  ...
  return regeneratorRuntime.wrap(
    function workGetSongsFetch$(_context) {
      while (1) {
        switch ((_context.prev = _context.next)) {
          ...
          case 6:
            ...
            return (0, _effects.put)(
              (0, _songs.getSongsSuccess)(formattedSongsShortened)
            );
...
function updateSongAsync(action) {
  ...
  return regeneratorRuntime.wrap(
    function updateSongAsync$(_context3) {
      while (1) {
        switch ((_context3.prev = _context3.next)) {
          case 0:
            ...
            (_action$payload = action.payload),
              ...
              (updatedSong = _objectWithoutProperties(_action$payload, ["id"]));
            _context3.next = 4;
            return (0, _effects.call)(
              fetch,
              "http://localhost:5000/songs/".concat(id),
              {
                method: "PUT",
...
function deleteSongAsync(action, id) {
  return regeneratorRuntime.wrap(
    function deleteSongAsync$(_context4) {
      while (1) {
        switch ((_context4.prev = _context4.next)) {
          case 0:
            ...
            return (0, _effects.call)(
              fetch,
              "http://localhost:5000/songs/".concat(action.id),
              {
                method: "DELETE",
              }
            );
